...
namespace Juime.UnitTests
{
    ...
    ///</summary>
    [TestClass()]
    public class AccordionOptionBuilderTest
    {
        ...
        public void HtmlAttribute_SetsCssClassAttribute()
        {
            ...
            AccordionOptionBuilder target = new AccordionOptionBuilder();
        ...
        public string AccordionHtmlBuilder(AccordionOptionBuilder target)
        {
